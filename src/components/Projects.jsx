...
const projects = [
  {
    ...
    technologies: "ReactJS, JavaScriptES6, HTML5, CSS3, Bootstrap, Material UI, MongoDB, Mongoose, Node.js, ExpressJS",
  ...
  },
  {
    ...
    author: "E",
    image: libraryWeb,
    description: "Fully functional CRUD app that works like a community of book readers that allow users to search a book from Google Books API and consult its details, create their own book collections to classify them as pending, reading or read and find and consult the lists of other registered users.",
    technologies: "JavaScriptES6, HTML5, CSS3, Bootstrap, MongoDB, Mongoose, Node.js, ExpressJS, Handlebars",
  ...
  },
  {
    ...
    author: "E",
    image: pokeRex,
    description: "Fully functional game inspired by classic Chrome T-Rex dinosaur but with Pokemon theme, using HTML, CSS & JavaScript, with HTML canvas for graphics and deployed online using GitHub Pages.",
